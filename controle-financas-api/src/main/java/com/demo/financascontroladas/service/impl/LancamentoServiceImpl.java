...
import com.demo.financascontroladas.model.repository.LancamentoDAO;
import com.demo.financascontroladas.service.LancamentoService;

@Service
public class LancamentoServiceImpl implements LancamentoService {
	
	private LancamentoDAO repository;
	
	public LancamentoServiceImpl(LancamentoDAO repository) {
